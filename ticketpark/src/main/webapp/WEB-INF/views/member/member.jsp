...
<div class="container">
	<div class="body-container">	
	    ...
	    <div class="alert alert-info" role="alert">
	        <i class="bi bi-person-check-fill"></i> ticketPark의 회원이 되시면 회원님만의 유익한 정보를 만날수 있습니다.
	    </div>
		...
		<div class="body-main">
			...
			<form name="memberForm" method="post">
			    	...
			    	<div class="col-sm-10">
			    		<div>
			    			<select name="selectGender" id="selectGender" class="form-select">
								<option value="">선 택</option>
								<option value="1" ${dto.gender=="1" ? "selected='selected'" : ""}>남자</option>
								<option value="0" ${dto.gender=="0" ? "selected='selected'" : ""}>여자</option>
							</select>
			    		</div>
			    	</div>
			    </div>
			    ...
			    <div class="row mb-3">
			    	<label class="col-sm-2 col-form-label" for="genre">좋아하는 장르</label>
			    	<div class="col-sm-10">
			    		<div>
			    			<input type="checkbox" name="genre" value="로코" ${dto.genre=="로코" ? "checked='checked'" : ""}> 로코 
			    			<input type="checkbox" name="genre" value="호러" ${dto.genre=="호러" ? "checked='checked'" : ""}> 호러 
			    			<input type="checkbox" name="genre" value="멜로" ${dto.genre=="멜로" ? "checked='checked'" : ""}> 멜로 
			    		</div>
			    	</div>
			    </div>
