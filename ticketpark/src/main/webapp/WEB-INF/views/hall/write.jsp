...
function sendOk() {
	...
	f.action = "${pageContext.request.contextPath}/hall/${mode}";
	f.submit();
}
...
$(function(){
	$(".delete-img").click(function(){
		...
		var url="${pageContext.request.contextPath}/hall/deleteFile";
				...
				<table class="table table-borderless">
 					<tr>
						<td class="text-center">
							...
							<button type="button" class="btn btn-light" onclick="location.href='${pageContext.request.contextPath}/hall/list';">${mode=='update'?'수정취소':'등록취소'}&nbsp;<i class="bi bi-x"></i></button>
							<c:if test="${mode=='update'}">
