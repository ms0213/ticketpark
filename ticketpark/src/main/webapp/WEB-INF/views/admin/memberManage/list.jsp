...
function searchList() {
	...
	f.enable.value=$("#selectEnable").val();
	...
	<div class="body-container">
	    ...
	    <div class="body-main ms-30">
			...
			<div id="tab-content" style="clear:both; padding: 20px 10px 0;">
				...
				<table class="table">
					<tr>
						<td align="left" width="50%" style="color: white;">
							${dataCount}개(${page}/${total_page} 페이지)
						</td>
						<td align="right">
							<select id="selectEnable" class="selectField" onchange="searchList();">
								<option value="" ${enable=="" ? "selected='selected'":""}>::계정상태::</option>
								<option value="0" ${enable=="0" ? "selected='selected'":""}>잠금 계정</option>
								<option value="1" ${enable=="1" ? "selected='selected'":""}>활성 계정</option>
							</select>
						</td>
					</tr>
				</table>
