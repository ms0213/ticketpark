		...
		<li class="gn-trigger"><a class="gn-icon gn-icon-menu"><span>Menu</span></a>
			<nav class="gn-menu-wrapper">
				<div class="gn-scroller">
					<ul class="gn-menu">
						<li><a class="gn-icon gn-icon-download" href="${pageContext.request.contextPath}/admin/memberManage/list">회원 관리</a>
						<li><a class="gn-icon gn-icon-download" href="">공연장 관리</a>
							<ul class="gn-menu">
								<li><a class="gn-icon gn-icon-photoshop" href="${pageContext.request.contextPath}/admin/theaterManage/main">상영관 관리
										</a></li>
							</ul></li>
