...
<button type="button" onclick="location.href='${pageContext.request.contextPath}/test/list?category=musical&categoryNum=1'">뮤지컬
</button>
<button type="button" onclick="location.href='${pageContext.request.contextPath}/test/list?category=concert&categoryNum=3'">콘서트
</button>
<button type="button" onclick="location.href='${pageContext.request.contextPath}/test/list?category=drama&categoryNum=2'">연극
</button>
<button type="button" onclick="location.href='${pageContext.request.contextPath}/test/list?category=all&categoryNum=0'">전체
</button>
